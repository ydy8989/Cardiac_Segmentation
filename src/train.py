...
parser.add_argument('--data_dir', type=str, default='/home/ydy8989/cardiac_20181229/data/train/CHD',
                    help='Directory of stored data.')
parser.add_argument('--checkpoint_dir',type=str, default='/home/ydy8989/cardiac_20181229/data/model/CHD_dia',
